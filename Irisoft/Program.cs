...
builder.Services.AddTransient<IVentaDiariaRepositorio,VentaDiariaRepositorio>();
builder.Services.AddTransient<IRepositorioEmpleado,RepositorioEmpleado>();
builder.Services.AddTransient<IRepositorioLaboratorio,RepositorioLaboratorio>();
